...
public class ContentPosting : IContentPosting
{
	...
	public async Task<TokenResponseDto> GetToken(string clientKey, string clientSecret, string code, string redirectUri)
	{
		SetContentType("application/x-www-form-urlencoded");
		HttpRequestMessage request = new(HttpMethod.Post, @"https://open.tiktokapis.com/v2/oauth/token/");
